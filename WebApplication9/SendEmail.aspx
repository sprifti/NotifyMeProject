...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <h4 class="text-center">Shkruani nje pergjigje per lajmerimin</h4>
            <h5 class="text-center">Ky email do ti degohet personit qe ka kryer lajmerimin! </h5>
        </div>
    </div>
    <br>
    <div class="row ">
    ...
    <div class="row ">
        <div class="col-sm-12 col-md-12 col-lg-12 input_ ">
            ...
            <asp:TextBox ID="subject" runat="server" ReadOnly="true" class="form-control"></asp:TextBox><br />
        </div>
    </div>
    <div class="row ">
        <div class="col-sm-12 col-md-12 col-lg-12 input_ ">
